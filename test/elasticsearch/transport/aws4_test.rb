  ...
  before do
    ...
    @request = stub_request(
      ...
      headers: {
        ...
        "Authorization"        => "AWS4-HMAC-SHA256 Credential=KEY_KEY_KEY_KEY/20150101/us-east-1/es/aws4_request, SignedHeaders=host;user-agent;x-amz-content-sha256;x-amz-date, Signature=a613a4b804bbe279e338b5d5fdd5caa9cb87efe61e7f54920eca7885f6ca822d",
